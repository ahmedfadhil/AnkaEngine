/**
 * Created by ahmedfadhil on 3/25/16.
 */
...
$(document).ready(function () {
    ...
    // setup plan change event listener #tenant_plan id in the form for class cc_form
    $('#tenant_plan').on('change', function (event) {
        handlePlanChange($('#tenant_plan :selected').val(), ".cc_form");
    });
    // call plan change handler to set the plan correctly when page loads
